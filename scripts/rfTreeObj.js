var treeObj = function(currTree) {

    //console.log("rfTreeObj selected tree: ", currTree);
    var currSelectedTree = currTree;

    var trackTraversal = function(data, tree, condition) {
        if(!tree.children) {
            var outputVal = tree.class;
            tree.traversed = condition;
            //console.log("tracking", condition);
            return outputVal;
    ...
    var travCond = true;
    trackTraversal(dataObject, currSelectedTree, travCond);
    //console.log("finished traversin",currSelectedTree);
    ...
    nodeEnter.append('text')
        ...
        .text(function(d) { 
            ...
            if(!d.data.children) {
                ...
                return d.data.variable + ", Split at: " + d.data.splitVal;
            }
        })
        .append('text')
        .attr("dy", ".7em")
        ...
        .text(function(d) {
            if(d.data.children) {
                return "Split Value: " + d.data.splitVal
            }
        });
